...
public class TileEntityCompactor extends TileEntity implements IInventory, ITickable {
	...
	private boolean canSmelt()
	{
		...
		else
		{
			...
			ItemStack result = CompactorRecipes.getInstance().getCompactorResult((ItemStack)this.inventory.get(0));
...
//				return res <= getInventoryStackLimit() && res <= output.getMaxStackSize();
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = CompactorRecipes.getInstance().getCompactorResult(input1);
			ItemStack output = (ItemStack)this.inventory.get(2);
	...
	{
		return "tutorial:compactor_furnace";
	}
