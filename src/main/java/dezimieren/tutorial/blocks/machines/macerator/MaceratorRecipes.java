...
public class MaceratorRecipes {
	...
	{
		this.addMaceratorRecipe(new ItemStack(Blocks.COBBLESTONE), new ItemStack(Blocks.GRAVEL), 0.1F);
		this.addMaceratorRecipe(new ItemStack(Blocks.STONE), new ItemStack(Blocks.COBBLESTONE), 0.1F);
		this.addMaceratorRecipe(new ItemStack(Blocks.STONEBRICK), new ItemStack(Blocks.COBBLESTONE), 0.1F);
		this.addMaceratorRecipe(new ItemStack(Blocks.GRAVEL), new ItemStack(Blocks.DIRT), 0.1F);
		this.addMaceratorRecipe(new ItemStack(Blocks.DIRT), new ItemStack(Blocks.CLAY), 0.1F);
		this.addMaceratorRecipe(new ItemStack(Blocks.CLAY), new ItemStack(Blocks.SAND), 0.1F);
		this.addMaceratorRecipe(new ItemStack(Blocks.OBSIDIAN), new ItemStack(ModItems.OBSIDIAN_SHARD), 1.0F);
