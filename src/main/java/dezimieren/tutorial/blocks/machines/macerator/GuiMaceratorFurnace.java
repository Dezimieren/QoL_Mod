...
public class GuiMaceratorFurnace extends GuiContainer {
	
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/gui/macerator_furnace.png");
	private final InventoryPlayer player;
	private final TileEntityMacerator tileentity;
	
	public GuiMaceratorFurnace(InventoryPlayer player, TileEntityMacerator tileentity)
	{
		super(new ContainerMacerator(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		if (TileEntityMacerator.isBurning(tileentity))
		{
