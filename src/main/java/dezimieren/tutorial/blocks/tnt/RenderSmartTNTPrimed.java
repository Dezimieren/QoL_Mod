...
public class RenderSmartTNTPrimed extends Render<entitySmartTNT>{
	...
	public void doRender(entitySmartTNT entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        blockrendererdispatcher.renderBlockBrightness(ModBlocks.SMART_TNT.getDefaultState(), entity.getBrightness());
        ...
        if (this.renderOutlines)
        {
            ...
            blockrendererdispatcher.renderBlockBrightness(ModBlocks.SMART_TNT.getDefaultState(), 1.0F);
