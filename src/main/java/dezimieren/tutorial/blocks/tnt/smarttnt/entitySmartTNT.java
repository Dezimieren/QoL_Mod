...
public class entitySmartTNT extends Entity
{
    private static final DataParameter<Integer> FUSE = EntityDataManager.<Integer>createKey(entitySmartTNT.class, DataSerializers.VARINT);
    @Nullable
    private EntityLivingBase tntPlacedBy;
    /** How long the fuse is */
    private int fuse;

    public entitySmartTNT(World worldIn)
    {
        super(worldIn);
        this.fuse = 80;
    ...
    public entitySmartTNT(World worldIn, double x, double y, double z, EntityLivingBase igniter)
    {
        this(worldIn);
